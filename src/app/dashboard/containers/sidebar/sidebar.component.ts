...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private reslover: ComponentFactoryResolver,
  ...
  subscribeToStartCall() {
    this.videoChatService.calling$.subscribe(vibiioCall => {
  ...
  subscribeToEndCall() {
    this.videoChatService.hangingUp$.subscribe(vibiio => {
  ...
  getStatusUpdate() {
    this.statusService
      .getCustomerStatus()
      .subscribe(
        (data: CustomerStatusCount[]) => (this.customersCategories = data)
      );
  }
